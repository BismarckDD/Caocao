...
// static check that WidgetGroup implements Widget interface.
...
func (wg *WidgetGroup) Render(target c2interface.Surface) {
...
func (wg *WidgetGroup) renderDebug(target c2interface.Surface) {
