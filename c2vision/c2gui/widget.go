...
type MouseHandler func(c2interface.MouseEvent)

// MouseMoveHandler is a handler function for mouse movement events
type MouseMoveHandler func(c2interface.MouseMoveEvent)

type widget interface {
	render(target c2interface.Surface) // draw
	advance(elapsed float64) error     // update

	onMouseMove(event c2interface.MouseMoveEvent) bool
	onMouseEnter(event c2interface.MouseMoveEvent) bool
	onMouseLeave(event c2interface.MouseMoveEvent) bool
	onMouseOver(event c2interface.MouseMoveEvent) bool
	onMouseButtonDown(event c2interface.MouseEvent) bool
	onMouseButtonUp(event c2interface.MouseEvent) bool
	onMouseButtonClick(event c2interface.MouseEvent) bool
...
func (w *widgetBase) render(_ c2interface.Surface) { /* NOOP */ }

func (w *widgetBase) advance(_ float64) error {
	return nil
}

func (w *widgetBase) onMouseEnter(event c2interface.MouseMoveEvent) bool {
...
func (w *widgetBase) onMouseLeave(event c2interface.MouseMoveEvent) bool {
...
func (w *widgetBase) onMouseButtonClick(event c2interface.MouseEvent) bool {
...
func (w *widgetBase) onMouseMove(_ c2interface.MouseMoveEvent) bool {
	return false
}

func (w *widgetBase) onMouseOver(_ c2interface.MouseMoveEvent) bool {
	return false
}

func (w *widgetBase) onMouseButtonDown(_ c2interface.MouseEvent) bool {
	return false
}

func (w *widgetBase) onMouseButtonUp(_ c2interface.MouseEvent) bool {
	return false
}
